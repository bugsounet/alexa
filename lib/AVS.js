...
class AVS {
  constructor(options = {}) {
    ...
    if (options.debug) {
      ...
      console.log("[AVS] Config:", options)
    }
  }
  ...
  requestMic(file) {
    ...
    var micInstance = new Record({ 'sampleRate': '16000', 'channels': '1', 'debug': this._debug, 'verbose': this._verbose, 'exitOnSilence': 15, device: "plughw:0" }, outputFileStream)
